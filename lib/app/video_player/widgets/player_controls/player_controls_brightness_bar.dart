          ...
          return SizedBox(
            ...
            child: Column(
              children: [
                ...
                if (value == 0)
                  const Icon(HugeIcons.strokeRoundedSun01, size: 10)
                else if (value < 33)
                  const Icon(HugeIcons.strokeRoundedSun01, size: 12)
                else if (value < 66)
                  const Icon(HugeIcons.strokeRoundedSun01, size: 14)
                else
                  const Icon(HugeIcons.strokeRoundedSun01, size: 16),
              ],
            ),
          );
        },
