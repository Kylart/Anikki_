...
class Arguments extends Equatable {
  ...
  factory Arguments.fromMap(Map<String, dynamic> data) => Arguments(
    ...
    scriptTorrentAddedEnabled: data['script-torrent-added-enabled'] as bool?,
    ...
    scriptTorrentDoneFilename: data['script-torrent-done-filename'] as String?,
    ...
    trashOriginalTorrentFiles: data['trash-original-torrent-files'] as bool?,
