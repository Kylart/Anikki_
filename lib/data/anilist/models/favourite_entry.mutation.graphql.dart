...
class _CopyWithImpl$Variables$Mutation$ToggleFavourite<TRes>
  ...
  TRes call({Object? animeId = _undefined}) => _then(
    Variables$Mutation$ToggleFavourite._({
      ..._instance._$data,
...
const documentNodeMutationToggleFavourite = DocumentNode(
  definitions: [
...
typedef OnMutationCompleted$Mutation$ToggleFavourite =
    ...
    graphql.OnError? onError,
       ...
       super(
         ...
         onCompleted: onCompleted == null
             ...
             : (data) => onCompleted(
                 data,
                 data == null ? null : _parserFn$Mutation$ToggleFavourite(data),
               ),
         update: update,
         onError: onError,
...
extension ClientExtension$Mutation$ToggleFavourite on graphql.GraphQLClient {
  Future<graphql.QueryResult<Mutation$ToggleFavourite>> mutate$ToggleFavourite([
    Options$Mutation$ToggleFavourite? options,
  ]) async => await this.mutate(options ?? Options$Mutation$ToggleFavourite());
