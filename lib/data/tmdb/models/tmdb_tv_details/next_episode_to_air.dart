...
class NextEpisodeToAir extends Equatable {
  ...
  factory NextEpisodeToAir.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [NextEpisodeToAir].
  factory NextEpisodeToAir.fromJson(String data) {
    return NextEpisodeToAir.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [NextEpisodeToAir] to a JSON string.
